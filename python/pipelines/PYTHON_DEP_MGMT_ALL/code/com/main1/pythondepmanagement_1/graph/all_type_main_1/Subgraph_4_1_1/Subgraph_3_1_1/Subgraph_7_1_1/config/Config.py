from com.main1.pythondepmanagement_1.graph.all_type_main_1.Subgraph_4_1_1.Subgraph_3_1_1.Subgraph_7_1_1\
    .Subgraph_8_1_1\
    .config\
...
class SubgraphConfig(ConfigBase):
    ...
    def __init__(self, prophecy_spark=None, Subgraph_8_1_1: dict={}, **kwargs):
